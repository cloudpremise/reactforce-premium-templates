        ...
        <GlobalNavigationBar>
            {
                sessionId.length > 0 ?
                    <GlobalNavigationBarRegion region="secondary" navigation>
                        ...
                        <li className={'slds-context-bar__item '+(state.activeUrl === "/cases" ? "slds-is-active" : "")}>
                            <span url="/cases" onClick={(event) => onUrlChange(event)} className="slds-context-bar__label-action" title='Settings'>
                ...
                <div id="global_wrapper">
                    <div id="global_content" style={{paddingTop: "15px", paddingBottom: "15px"}} data-testid="content">
                        <Routes>
                            ...
                            <Route path="/cases" element={<Cases history={history} basename={basename} page={page} />} />
                        </Routes>
                    </div>
                </div>
            </>
