...
import { ACCORDION_PANEL } from '@salesforce/design-system-react/utilities/constants';
		...
		>
			<div className="slds-accordion__summary">
				<h3 className="slds-text-heading_small slds-accordion__summary-heading slds-has-flexi-truncate">
					...
					>
                        <InlineIcon
                            className={"slds-button__icon slds-accordion__summary-action-icon slds-button__icon slds-button__icon_left"}
                            category="utility"
                            name="switch"
                            size="x-small"
                        />
